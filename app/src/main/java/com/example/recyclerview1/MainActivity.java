...
//                showSelectedFood(data);
                Intent moveIntent = new Intent(MainActivity.this, FoodDetailActivity.class);
                moveIntent.putExtra(FoodDetailActivity.ITEM_EXTRA, data);
